...
<img height="80%" alt="OpenSearch Discovery Search Box with a Query for a MySql error that resulted in a 500 response code" src="search.png">

----

<img height="80%" alt="OpenSearch Discovery Screen Generated by Running a Query for a MySql error that resulted in a 500 response code" src="discovery.png">
